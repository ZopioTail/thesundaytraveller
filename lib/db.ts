...
export const updateUser = firestore.updateUser
export const getCategories = firestore.getCategories
export const getCategoryById = firestore.getCategoryById
export const createCategory = firestore.createCategory
export const updateCategory = firestore.updateCategory
export const deleteCategory = firestore.deleteCategory
export const getTags = firestore.getTags
export const getMediaById = firestore.getMediaById
export const updateMedia = firestore.updateMedia
export const deleteMedia = firestore.deleteMedia
export const getTagById = firestore.getTagById
export const updateTag = firestore.updateTag
export const deleteTag = firestore.deleteTag
export const getActiveUsers = firestore.getActiveUsers
export const createNotification = firestore.createNotification
export const getNotificationsByUser = firestore.getNotificationsByUser
export const getSetting = firestore.getSetting
export const setSetting = firestore.setSetting
export const searchPostsAdvanced = firestore.searchPostsAdvanced
export const getSearchSuggestions = firestore.getSearchSuggestions
